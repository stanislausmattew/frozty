  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="adminpromo">
            <i class="bi bi-card-list"></i>
            <span>Promo</span>
            </a>
        </li>
                        ...
                        <div class="card-body">
                          ...
                          <table class="table table-borderless datatable">
                              ...
                              <tbody>
                                    @php
                                    @endphp
                                    @foreach ($listpromo as $lp)
                                        <tr>
                                            <th scope="row">{{$lp->Nama}}</th>
                                            <td>{{$lp->Potongan}}%</td>
                                            <td>{{$lp->Deskripsi}}</td>
                                            <td>{{$lp->TGL_Start}}</td>
                                            <td>{{$lp->TGL_END}}</td>
                                            <td>
                                                <a href="{{url('/hapusPromo/'.$lp->id)}}"><span class="badge bg-danger">Hapus</span></a>
                                            </td>
                                        </tr>
                                    @endforeach
                              </tbody>
                        ...
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                  ...
                                  <p class="text-center small">Masukkan detil data promo</p>
                                </div>

                                <form class="row g-3 needs-validation" novalidate action="adminpromo" method="POST" enctype="multipart/form-data">
                                  @csrf
                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Nama Promo</label>
                                        <input type="text" name="namapromo" class="form-control" id="nama" required>
                                        <div class="invalid-feedback">Mohon isi dengan nama produk!</div>
                                    </div>

                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Potongan Promo</label>
                                        <input type="text" name="potonganpromo" class="form-control" id="nama" required>
                                        <div class="invalid-feedback">Mohon isi dengan nama produk!</div>
                                    </div>

                                    <div class="col-12">
                                        <label for="yourName" class="form-label">Deskripsi Promo</label>
                                        <input type="text" name="deskripsipromo" class="form-control" id="nama" required>
                                        <div class="invalid-feedback">Mohon isi dengan deskripsi promo!</div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="invalid-feedback">Mohon isi dengan tanggal awal promo!</div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="invalid-feedback">Mohon isi dengan tanggal akhir promo!</div>
                                    </div>
