...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/adminakun">
          <i class="bi bi-person"></i>
          <span>Akun</span>
        </a>
                ...
                <div class="tab-content pt-2">
                  ...
                  <div class="tab-pane fade show active profile-overview" id="profile-overview">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-9 col-md-8">{{$userLoggedIn->Nama}}</div>
                    </div>

                    <div class="row">
                      <div class="col-lg-3 col-md-4 label">Username</div>
                      <div class="col-lg-9 col-md-8">{{$userLoggedIn->Username}}</div>
                    </div>

                    <div class="row">
                      <div class="col-lg-3 col-md-4 label">Surel</div>
                      <div class="col-lg-9 col-md-8">{{$userLoggedIn->Email}}</div>
                    </div>
